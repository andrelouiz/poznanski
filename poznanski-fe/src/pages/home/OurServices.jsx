      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-12">
        <div className="md:w-1/2">
          <div className="text-left md:w-4/5">
            ...
            <p className="my-5 text-secondary text-white leading-[30px]"> Immersed in our dedication, we meticulously select cutting-edge network solutions for enterprises,
